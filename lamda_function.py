...
def set_name(intent, session):
    ...
    speech_output = "Thank You " + name +" "+". Would you like to share your day or would you like to get some suggestions?"
...
def on_intent(intent_request, session):
    ...
    if intent_name == "TellYourName":
        return set_name(intent, session)
